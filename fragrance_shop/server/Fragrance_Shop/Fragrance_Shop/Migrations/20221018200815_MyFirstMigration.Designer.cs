...
namespace Fragrance_Shop.Migrations
{
    ...
    [Migration("20221018200815_MyFirstMigration")]
            ...
            modelBuilder.Entity("Fragrance_Shop.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            img_links = "assets/img/just_dropped/0/0.jpg;assets/img/just_dropped/0/1.jpg",
                        ...
                        new
                        {
                            ...
                            img_links = "assets/img/just_dropped/2/0.jpg;assets/img/just_dropped/2/1.jpg;assets/img/just_dropped/2/2.jpg",
                        ...
                        new
                        {
                            ...
                            img_links = "assets/img/just_dropped/6/0.jpg;assets/img/just_dropped/6/1.jpg",
                            name = "Base Concealer",
                            price = 20.0,
                            price_discount = 0.0
                        },
